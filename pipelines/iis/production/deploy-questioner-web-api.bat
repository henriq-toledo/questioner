...
REM Publish
dotnet publish --configuration Release --runtime win10-x64 /p:EnvironmentName=Production --no-self-contained --output "C:\Temp\questioner-api\publish" "C:\Temp\questioner-api\build\src\Questioner\Questioner.WebApi\Questioner.WebApi.csproj"
